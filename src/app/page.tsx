          ...
          {achievers.length > 0 ? (
            ...
            <div className="bg-[#FAF7F2] rounded-3xl p-8 sm:p-10 border border-[#C5A059]/30 text-center max-w-2xl mx-auto shadow-sm">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed mb-6">
                ऋषिकुल के जिन पूर्व स्नातक / स्नातकोत्तरों ने राष्ट्रीय स्तर पर विशिष्ट कीर्तिमान स्थापित किए हैं अथवा जो एसोसिएशन के संरक्षक मंडल (Patrons) से जुड़े हैं, उन्हें सम्मानित करने हेतु यह विशेष खंड समर्पित है।
              </p>
