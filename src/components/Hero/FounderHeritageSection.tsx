      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xs sm:text-sm text-[#64748B] mt-2 leading-relaxed">
            भारत रत्न महामना पंडित मदन मोहन मालवीय जी की अमृत दृष्टि और 17 वर्षीय अमर बलिदानी छात्र जगदीश वत्स जी का सर्वोच्च राष्ट्र-समर्पण — ऋषिकुल के प्रत्येक पूर्व स्नातक / स्नातकोत्तर के लिए शाश्वत प्रेरणा है।
          </p>
        </div>
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 md:p-10 border-2 border-[#C5A059]/40 shadow-xl flex flex-col justify-between relative overflow-hidden group hover:border-[#C5A059] transition-all">
            ...
            <div>
              ...
              <div className="space-y-3 text-xs sm:text-sm text-slate-700 leading-relaxed font-light mb-6">
                ...
                <p>
                  मालवीय जी का स्पष्ट स्वप्न था कि यहाँ से ऐसे वैद्य और शल्य-चिकित्सक (Ayurvedic Physicians & Surgeons) तैयार हों जो आधुनिक विज्ञान और चरक-सुश्रुत की प्राचीन सनातन परंपरा दोनों में अद्वितीय हों। आज ऋषिकुल के 12,000+ पूर्व स्नातक / स्नातकोत्तर उसी पावन संकल्प का प्रत्यक्ष विस्तार हैं।
                </p>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-[10px] text-slate-300">
                    ऋषिकुल स्नातक एवं स्नातकोत्तर एसोसिएशन अपने इस अमर बलिदानी छात्र को शत-शत नमन करती है।
                  </div>
                </div>
                <Link
                  href="/shradhanjali"
